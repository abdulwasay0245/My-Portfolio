        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:col-span-4 lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              <a href="#services" className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">Service</a>
              <a href="#portfolio" className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">Project</a>
              <a href="#testimonials" className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">Reviews</a>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-4 lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 mt-2">
              <a href={`tel:${siteSettings.phone || '+91 7738443636'}`} className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">{siteSettings.phone || "+91 7738443636"}</a>
              <a href={`mailto:${siteSettings.email || 'Jaycrea36@gmail.com'}`} className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">{siteSettings.email || "hello@abdulwasay.com"}</a>
              <a href="https://wasaydevops.vercel.app" className="font-sans text-[15px] text-white hover:text-brand-orange transition-colors">wasaydevops.vercel.app</a>
            </div>
          </motion.div>
